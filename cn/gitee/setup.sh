###
 ...
 # @LastEditors: 喵二
 # @LastEditTime: 2024-07-31 23:54:05
 # @FilePath: \undefinedd:\ls\unlock-redmi-ax6000\cn\gitee\setup.sh
### 
#!/bin/bash
if [ $(id -u) != "0" ]; then
...
uci_readly(){
    ...
    mkdir /data/auto_ssh
    cd /data/auto_ssh
    curl -O https://gitee.com/miaoermua/unlock-redmi-ax6000/raw/main/auto_ssh.sh
